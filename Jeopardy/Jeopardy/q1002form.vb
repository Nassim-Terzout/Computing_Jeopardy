Public Class q1002form
    Private Sub Nextq1001_Click(sender As Object, e As EventArgs) Handles Nextq1002.Click
        If LCase(q1002ans.Text) = "malware" Or LCase(q1002ans.Text) = "virus" Then
            Boardform.s += 200
            Boardform.score.Text = Boardform.s
            Boardform.q1002.Visible = False
            ...
            Resultsq100.qresult.Text = "You're right! Keep it up " & Startmenu.pname.Text & "!"

                Resultsq100.qresultgood12.Visible = True
            ...
            Resultsq100.qresult.Text = "Unlucky, " & Startmenu.pname.Text & ", harmful software goes by the name virus or malware!"
                Resultsq100.qresultbad12.Visible = True
            Resultsq100.qresultgood11.Visible = False
    ...
    Private Sub q1002text_Click(sender As Object, e As EventArgs) Handles q1002text.Click
