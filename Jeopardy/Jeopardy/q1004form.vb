Public Class q1004form
    Private Sub q1001ans1_CheckedChanged(sender As Object, e As EventArgs) Handles q1004ans1.CheckedChanged

    End Sub

    Private Sub Nextq1001_Click(sender As Object, e As EventArgs) Handles Nextq1004.Click
        If q1004ans1.Checked = True Then
            Boardform.s += 400
            Boardform.score.Text = Boardform.s
            Boardform.q1004.Visible = False
            Resultsq100.qresult.Text = "Well done!"
            Resultsq100.qresultgood14.Visible = True
        ...
        Else
            ...
            Boardform.score.Text = Boardform.s
            Boardform.q1004.Visible = False
            Resultsq100.qresult.Text = "Incorrect! The FBI recommends you keep your firewall on, update antivirus software, and turn off PC when not being used!"
            Resultsq100.qresultbad14.Visible = True
            Resultsq100.qresultgood11.Visible = False
            Resultsq100.qresultgood12.Visible = False
            Resultsq100.qresultgood13.Visible = False
    ...
    Private Sub q1004text_Click(sender As Object, e As EventArgs) Handles q1004text.Click
