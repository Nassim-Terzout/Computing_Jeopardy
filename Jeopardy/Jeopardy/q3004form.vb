Public Class q3004form
    Private Sub Nextq3004_Click(sender As Object, e As EventArgs) Handles Nextq3004.Click
        If q3004ans4.Checked = True Then
            Boardform.s += 400
            Boardform.score.Text = Boardform.s
            Boardform.q3004.Visible = False
            Resultsq100.qresult.Text = "Excellent " & Startmenu.pname.Text & "! If/Then statements is correct!"
            Resultsq100.qresultgood34.Visible = True
        ...
        Else
            ...
            Boardform.score.Text = Boardform.s
            Boardform.q3004.Visible = False
            Resultsq100.qresult.Text = "Wrong answer " & Startmenu.pname.Text & "! The correct answer was If/Then statements!"
            Resultsq100.qresultbad34.Visible = True
            Resultsq100.qresultgood11.Visible = False
            Resultsq100.qresultgood12.Visible = False
            Resultsq100.qresultgood13.Visible = False
            Resultsq100.qresultgood14.Visible = False
