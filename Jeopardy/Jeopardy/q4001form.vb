Public Class q4001form
    Private Sub Nextq4001_Click(sender As Object, e As EventArgs) Handles Nextq4001.Click
        If LCase(q4001ans.Text) = "spacewar" Then
            Boardform.s += 100
            Boardform.score.Text = Boardform.s
            Boardform.q4001.Visible = False
            Resultsq100.qresult.Text = "Well done " & Startmenu.pname.Text & "! Spacewar is correct!"
            Resultsq100.qresultgood41.Visible = True
        ...
        Else
            ...
            Boardform.score.Text = Boardform.s
            Boardform.q4001.Visible = False
            Resultsq100.qresult.Text = "The correct answer was Spacewar!"
            Resultsq100.qresultgood41.Visible = True
            Resultsq100.qresultgood11.Visible = False
            Resultsq100.qresultgood12.Visible = False
            Resultsq100.qresultgood13.Visible = False
