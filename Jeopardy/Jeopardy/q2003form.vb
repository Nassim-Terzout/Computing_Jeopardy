Public Class q2003form
    Private Sub Nextq2001_Click(sender As Object, e As EventArgs) Handles Nextq2003.Click
        If LCase(q2003ans.Text) = "gpu" Or LCase(q2003ans.Text) = "graphics processing unit" Or LCase(q2003ans.Text) = "graphics card" Or LCase(q2003ans.Text) = "graphical processing unit" Or LCase(q2003ans.Text) = "video card" Then
            Boardform.s += 300
            Boardform.score.Text = Boardform.s
            Boardform.q2003.Visible = False
            Resultsq100.qresult.Text = "Incredible!"
            Resultsq100.qresultgood23.Visible = True
        ...
        Else
            ...
            Boardform.score.Text = Boardform.s
            Boardform.q2003.Visible = False
            Resultsq100.qresult.Text = "The correct answer was the GPU or video card!"
            Resultsq100.qresultbad23.Visible = True
            Resultsq100.qresultgood11.Visible = False
            Resultsq100.qresultgood12.Visible = False
            Resultsq100.qresultgood13.Visible = False
            Resultsq100.qresultgood14.Visible = False
    ...
    Private Sub q2003text_Click(sender As Object, e As EventArgs) Handles q2003text.Click
