Public Class q1003form
    Private Sub ans1q1003_Click(sender As Object, e As EventArgs) Handles ans1q1003.Click
        Boardform.s -= 300
        Boardform.score.Text = Boardform.s

        Boardform.q1003.Visible = False
        Resultsq100.qresult.Text = "The correct answer is the Tor web browser!"
        Resultsq100.qresultbad13.Visible = True
    ...
    Private Sub ans3q1003_Click(sender As Object, e As EventArgs) Handles ans3q1003.Click

        Boardform.s += 300
        Boardform.score.Text = Boardform.s
        Boardform.q1003.Visible = False
        Resultsq100.qresult.Text = "You got it!"
        Resultsq100.qresultgood13.Visible = True
        Resultsq100.qresultgood11.Visible = False
        Resultsq100.qresultgood12.Visible = False
    ...
    Private Sub ans2q1003_Click(sender As Object, e As EventArgs) Handles ans2q1003.Click
        Boardform.s -= 300
        Boardform.score.Text = Boardform.s
    ...
    Private Sub ans4q1003_Click(sender As Object, e As EventArgs) Handles ans4q1003.Click
        Boardform.s -= 300
        Boardform.score.Text = Boardform.s
    ...
    Private Sub Nextq1004_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub q1003back_Click(sender As Object, e As EventArgs) Handles q1003back.Click

    End Sub

    Private Sub q1003text_Click(sender As Object, e As EventArgs) Handles q1003text.Click
