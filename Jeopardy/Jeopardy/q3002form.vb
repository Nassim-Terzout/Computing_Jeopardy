Public Class q3002form
    Private Sub Nextq3002_Click(sender As Object, e As EventArgs) Handles Nextq3002.Click
        If q3002ans1.Checked = True Then
            Boardform.s += 200
            Boardform.score.Text = Boardform.s
            Boardform.q3002.Visible = False
            Resultsq100.qresult.Text = "Great Job " & Startmenu.pname.Text & "! You're correct!"
            Resultsq100.qresultgood32.Visible = True
        ...
        Else
            ...
            Boardform.score.Text = Boardform.s
            Boardform.q3002.Visible = False
            Resultsq100.qresult.Text = "The correct answer was the toolbox!"
            Resultsq100.qresultbad32.Visible = True
            Resultsq100.qresultgood11.Visible = False
            Resultsq100.qresultgood12.Visible = False
            Resultsq100.qresultgood13.Visible = False
            Resultsq100.qresultgood14.Visible = False
    ...
    Private Sub q3002ansback_Click(sender As Object, e As EventArgs) Handles q3002ansback.Click
