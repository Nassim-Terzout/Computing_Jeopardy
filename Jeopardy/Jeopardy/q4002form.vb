Public Class q4002form
    Private Sub Nextq4001_Click(sender As Object, e As EventArgs) Handles Nextq4002.Click
        If q4002ans1.Checked = True Then
            Boardform.s += 200
            Boardform.score.Text = Boardform.s
            Boardform.q4002.Visible = False
            Resultsq100.qresult.Text = "Correct! You've defined a whisteblower."
            Resultsq100.qresultgood42.Visible = True
        ...
        Else
            ...
            Boardform.score.Text = Boardform.s
            Boardform.q4002.Visible = False
            Resultsq100.qresult.Text = "Incorrect! A whistleblower is an individual who leaks information based on moral dilemma."
            Resultsq100.qresultbad42.Visible = True
            Resultsq100.qresultgood11.Visible = False
            Resultsq100.qresultgood12.Visible = False
            Resultsq100.qresultgood13.Visible = False
            Resultsq100.qresultgood14.Visible = False
