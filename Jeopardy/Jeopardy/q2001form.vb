Public Class q2001form
    Private Sub q2001ans1_Click(sender As Object, e As EventArgs) Handles q2001ans1.Click
        Boardform.s -= 100
        Boardform.score.Text = Boardform.s
        Boardform.q2001.Visible = False
        Resultsq100.qresult.Text = "This isn't the answer! The keyboard is the only input device in the presented images."
        Resultsq100.qresultbad21.Visible = True
    ...
    Private Sub q2001ans2_Click(sender As Object, e As EventArgs) Handles q2001ans2.Click
        Boardform.s -= 100
        Boardform.score.Text = Boardform.s
        Boardform.q2001.Visible = False
        Resultsq100.qresult.Text = "This isn't the answer! The keyboard is the only input device in the presented images."
    ...
    Private Sub q2001ans3_Click(sender As Object, e As EventArgs) Handles q2001ans3.Click
        Boardform.s += 100
        Boardform.score.Text = Boardform.s
        Boardform.q2001.Visible = False
        Resultsq100.qresult.Text = "Excellent!"
        Resultsq100.qresultgood21.Visible = True
        Resultsq100.qresultgood11.Visible = False
        Resultsq100.qresultgood12.Visible = False
        Resultsq100.qresultgood13.Visible = False
        Resultsq100.qresultgood14.Visible = False
    ...
    Private Sub q2001ans4_Click(sender As Object, e As EventArgs) Handles q2001ans4.Click
        Boardform.s -= 100
        Boardform.score.Text = Boardform.s
        Boardform.q2001.Visible = False
        Resultsq100.qresult.Text = "This isn't the answer! The keyboard is the only input device in the presented images."
    ...
    Private Sub q2001text_Click(sender As Object, e As EventArgs) Handles q2001text.Click
