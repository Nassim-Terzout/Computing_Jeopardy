Public Class q3001form
    Private Sub Nextq3001_Click(sender As Object, e As EventArgs) Handles Nextq3001.Click

        If LCase(q3001ans.Text) = "radio button" Then
            Boardform.s += 100
            Boardform.score.Text = Boardform.s

            Boardform.q3001.Visible = False
            Resultsq100.qresult.Text = "Radio Button is correct!!"
            Resultsq100.qresultgood31.Visible = True
        ...
        Else
            ...
            Boardform.score.Text = Boardform.s
            Boardform.q3001.Visible = False
            Resultsq100.qresult.Text = "You're incorrect! The correct answer was a Radio Button."
            Resultsq100.qresultbad31.Visible = True
            Resultsq100.qresultgood11.Visible = False
            Resultsq100.qresultgood12.Visible = False
            Resultsq100.qresultgood13.Visible = False
            Resultsq100.qresultgood14.Visible = False
    ...
    Private Sub borderanslabelq3001_Click(sender As Object, e As EventArgs) Handles borderanslabelq3001.Click

    End Sub

    Private Sub q3001text_Click(sender As Object, e As EventArgs) Handles q3001text.Click
